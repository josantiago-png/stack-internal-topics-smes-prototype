import"./BxG5rCjX.js";import{p as Oe,o as Le,n as r,f as U,a as Ne,m as A,aI as Qe,c as o,r as n,az as We,s as m,l as a,t as O,u as I,aJ as oe}from"./BzawszrY.js";import{d as Be,e as Ve,s as $,a as E}from"./B01qPSZT.js";import{c as Fe,a as x,f as M}from"./CJebljq8.js";import{i as L}from"./B8MEMlN3.js";import{h as ce}from"./CmCPBQNy.js";import{r as Ke}from"./BHqgkmEM.js";import{b as de,a as Ue}from"./BWiZjPlR.js";import{p as C}from"./C6T6ehsK.js";import{g as ve}from"./fiEJRRFe.js";const $e="Giamir Buoncristiani",je="Hey Giamir — I couldn't find an answer. Can you help?",ze="Why Giamir?",Ye="Why is this answer low trust?",p=[{value:"giamir",label:"Giamir Buoncristiani",handle:"@giamir",description:"Staff Developer",kind:"sme",avatar:"/community-embed/Home%20-%20Stack%20Overflow%20Demo%20Site_files/user.svg"},{value:"sander",label:"Sander van Vliet",handle:"@sander",description:"Data platform SME",kind:"sme",avatar:"/community-embed/Home%20-%20Stack%20Overflow%20Demo%20Site_files/user.svg"},{value:"priya",label:"Priya Shah",handle:"@priya",description:"Cloud infrastructure SME",kind:"sme",avatar:"/community-embed/Home%20-%20Stack%20Overflow%20Demo%20Site_files/user.svg"},{value:"cloud-infra",label:"#cloud-infra",handle:"#cloud-infra",description:"Public channel for infrastructure questions",kind:"channel"},{value:"eng-platform",label:"#eng-platform",handle:"#eng-platform",description:"Public channel for platform engineering questions",kind:"channel"}],Je=[{title:"Yak migrations spike",author:"Giamir Buoncristiani",icon:"/icon-google-docs.svg"}];function u(e){return e.trim().toLowerCase().replace(/[^\w@\s]/g,"").replace(/\s+/g," ")}function me(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function c(e){return me(e.trim())}function ue(e){return ve.parse(me(e.trim()),{breaks:!1})}function Ze(e=Je){return e.length?`<div class="ask-giamir-slack-preview__sources" aria-label="Sources">${e.map(i=>{const v=[i.author,i.date].filter(Boolean).join(" · ");return`<div class="ask-giamir-slack-preview__source-card" role="group" aria-label="${c(i.title)} source">
  ...
  </div>`}function Ia({intro:e,question:s,answer:i,destination:v=p[0]}){const g=v.kind==="channel"?"the channel":j(v);return`<div class="ask-giamir-edit-form" aria-label="Edit message for reviewer">
...
</div>`}function xa(e){return`<div class="ask-giamir-preview">
